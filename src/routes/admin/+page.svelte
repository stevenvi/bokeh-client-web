							...
							{#key $coverBustStore[coll.id]}
								<div class="relative mb-2 aspect-square w-full overflow-hidden rounded">
									<img
										...
										onerror={() => { coverLoadedStates[coll.id] = false; }}
									/>
									<div class="absolute inset-0 flex h-full w-full items-center justify-center bg-gradient-to-br from-surface-raised to-border transition-opacity duration-300" class:opacity-0={coverLoadedStates[coll.id]}>
