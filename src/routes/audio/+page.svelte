<script lang="ts">
	...
	import AudioSearchResults from '$lib/components/AudioSearchResults.svelte';
...
<main class="px-4 py-6">
	<div class="mb-6">
		<SearchBar bind:value={searchValue} {loading} placeholder="Search audio..." {onDebouncedChange} />
	</div>

	{#if debouncedQ.trim().length > 0}
		<AudioSearchResults q={debouncedQ.trim()} bind:loading />
