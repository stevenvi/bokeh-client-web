...
<button class="group w-full text-left" {onclick}>
	...
	>
		{#if category === 'photo'}
			<svg class="h-16 w-16 text-white/90" fill="none" viewBox="0 0 24 24" stroke="currentColor">
